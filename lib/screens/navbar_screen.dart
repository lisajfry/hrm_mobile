...
class _NavbarScreenState extends State<NavbarScreen> {
  ...
  final List<Widget> _pages = [
    HomeScreen(key: UniqueKey()),          // Index 0: Home Screen
    IzinScreen(key: UniqueKey()),          // Index 1: Izin Screen
    AbsensiScreen(key: UniqueKey()),       // Index 2: Absensi Screen
    DinasLuarKotaScreen(key: UniqueKey()), // Index 3: Dinas Luar Kota Screen
    ProfileScreen(key: UniqueKey()),       // Index 4: Profile Screen
  ];
